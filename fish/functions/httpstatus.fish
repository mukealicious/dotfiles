function httpstatus -d "HTTP status code lookup"
    set -l codes \
    ...
    if test (count $argv) -lt 1
        ...
        echo "  httpstatus 404    # Specific code"
        echo "  httpstatus 4*     # All 4xx codes"
        return 1
    end
    ...
    if test $found -eq 0
        echo "No status codes matching: $query"
        return 1
    end
end
