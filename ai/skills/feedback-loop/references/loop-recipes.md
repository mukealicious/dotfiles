...
Concrete steps, tooling, artifacts, and checklists for each loop type.
...
[agent-browser](https://github.com/vercel-labs/agent-browser) is a headless browser CLI built for AI agents. Uses accessibility tree snapshots + element refs instead of DOM — significantly less context than Playwright MCP.
