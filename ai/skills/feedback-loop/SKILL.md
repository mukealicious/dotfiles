...
|---|---|---|
| [loop-recipes.md](./references/loop-recipes.md) | Steps, tooling, artifacts, checklists per loop type | Starting a specific loop type |
| [examples.md](./references/examples.md) | Full worked loop iterations with hypotheses + decisions | Need to see the pattern in action |
