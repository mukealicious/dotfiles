...
metadata:
  watch-sources: cloudai-x/threejs-skills/skills/threejs-loaders@b1c623076c661fc9b03dac19292e825a5d106823
...
// Serve decoders locally in production — copy from node_modules/three/examples/jsm/libs/draco/
...
// Serve transcoder locally — copy from node_modules/three/examples/jsm/libs/basis/
...
// Custom URL modifier — only prepend trusted, known origins
const ASSET_ORIGIN = window.location.origin;
manager.setURLModifier((url) => {
  return `${ASSET_ORIGIN}/assets/${url}`;
});
```
