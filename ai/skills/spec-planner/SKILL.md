...
Explore the affected codebase to map what will change:
...
**If unfamiliar tech involved**, research recommended approaches and gotchas (e.g., via a library research agent or documentation lookup).
...
When available, delegate to specialized agents or tools:

| Role | When to Invoke |
|------|----------------|
| **Library/API researcher** | Research unfamiliar tech, APIs, frameworks |
| **Architecture advisor** | Deep architectural analysis, complex debugging |
